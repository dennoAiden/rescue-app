...
from sqlalchemy import Enum, func, DateTime, Integer, String, Float, Boolean
import requests
...
class Report(db.Model, SerializerMixin):
    ...
    response_time = db.Column(Integer)
    created_at = db.Column(DateTime, default=func.now())
...
class Admin(db.Model, SerializerMixin):
    ...
    id = db.Column(Integer, primary_key=True)
    incident_report_id = db.Column(Integer, db.ForeignKey('incident_reports.id'))
    emergency_only_id = db.Column(Integer, db.ForeignKey('emergencies.id'))
    action = db.Column(AdminActionEnum)
    admin_id = db.Column(Integer, db.ForeignKey('users.id'))
    created_at = db.Column(DateTime, default=func.now())
